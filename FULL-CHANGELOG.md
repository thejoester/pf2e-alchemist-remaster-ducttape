...
## Changed 
- **Indexing:** reworked the index of alchemical items used in the module to include potions (for Improbable Elixirs), and only reindexes once the index is 3 days old (this is in case pf2e system updates with new items.)
